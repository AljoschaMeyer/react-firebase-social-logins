...
},{"_process":134,"babel-runtime/helpers/class-call-check":5,"babel-runtime/helpers/extends":6,"babel-runtime/helpers/inherits":7,"babel-runtime/helpers/interop-require-default":8,"babel-runtime/helpers/object-without-properties":10,"classnames":undefined,"react":undefined,"warning":245}],195:[function(require,module,exports){
'use strict';
...
},{"../styleMaps":207,"_process":134,"babel-runtime/helpers/extends":6,"babel-runtime/helpers/interop-require-default":8,"invariant":63,"react":undefined,"warning":245}],212:[function(require,module,exports){
'use strict';
...
},{"_process":134,"babel-runtime/helpers/class-call-check":5,"babel-runtime/helpers/inherits":7,"babel-runtime/helpers/interop-require-default":8,"warning":245}],217:[function(require,module,exports){
/*eslint-disable react/prop-types */
'use strict';
...
module.exports = exports['default'];
},{"warning":245}],238:[function(require,module,exports){
...
module.exports = exports['default'];
},{"react":undefined,"react-bootstrap":206}],242:[function(require,module,exports){
'use strict';
...
},{"_process":134,"invariant":63,"react":undefined}],245:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{}],"react-firebase-social-logins":[function(require,module,exports){
'use strict';
...
var _reactSocialButton = require('react-social-button');

var _reactSocialButton2 = _interopRequireDefault(_reactSocialButton);

var ReactFirebaseSocialLogins = (function (_React$Component) {
  _inherits(ReactFirebaseSocialLogins, _React$Component);

  function ReactFirebaseSocialLogins(props) {
    _classCallCheck(this, ReactFirebaseSocialLogins);

    _get(Object.getPrototypeOf(ReactFirebaseSocialLogins.prototype), 'constructor', this).call(this, props);
    this.state = {
      loadingProvider: null
    };
  }

  _createClass(ReactFirebaseSocialLogins, [{
    key: 'render',
    value: function render() {
      ...
      var loginProvider = function loginProvider(provider) {
        return function () {
          _this.setState({ loadingProvider: provider });
          var self = _this;
          _this.props.fireRef.authWithOAuthPopup(provider, function (error, authData) {
            if (error) {
      ...
      var buttons = this.props.providers.map(function (provider) {
        var buttonProps = _this.props.btnProps;
        if (buttonProps === undefined || buttonProps === null) {
          buttonProps = {};
        }
        buttonProps.disabled = _this.state.loadingProvider !== null;
        buttonProps.onClick = _this.state.loadingProvider === null ? loginProvider(provider).bind(_this) : null;

        return _react2['default'].createElement(_reactSocialButton2['default'], {
          key: provider,
          social: provider,
          text: _this.props.textFn(provider),
          loading: _this.state.loadingProvider === provider,
          btnProps: buttonProps });
      });

      return _react2['default'].createElement(
        _reactBootstrap.ButtonToolbar,
        { className: 'socialLogins' },
        buttons
      );
    }
  }]);

  return ReactFirebaseSocialLogins;
})(_react2['default'].Component);
...
ReactFirebaseSocialLogins.propTypes = {
  fireRef: _react2['default'].PropTypes.object.isRequired,
  providers: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.string),
  textFn: _react2['default'].PropTypes.func,
...
exports['default'] = ReactFirebaseSocialLogins;
module.exports = exports['default'];

},{"react":undefined,"react-bootstrap":206,"react-social-button":241}]},{},[]);
